...
experiment_name = f"data_colored_fashionmnist_model_shared_colored_fashionmnist_expt_varying_model_size_{timestamp}"
...
eval_skip = num_samples_train // 50

assert num_samples_train % train_skip == 0
assert num_samples_train % eval_skip == 0

num_templates_to_train = list(range(train_skip, num_samples_train + 1, train_skip))
num_templates_to_evaluate = list(range(eval_skip, num_samples_train + 1, eval_skip))
...
config = {
    ...
    "num_samples_viz": num_samples_viz,
